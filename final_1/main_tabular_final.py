...
if __name__=='__main__':
    ...
    ##-----------------------------------------------------------------------------------------------------------
        ...
        featureNet_gumbelsparsemax_model, featureNet_gsp_sigmas, featureNet_gsp_sigma_y, featureNet_gsp_weights = call_HSIC_methods('HSICFeatureNet_GumbelSparsemax', X_tensor_bg, y_tensor_bg, feature_imp=1)
        ...
        L2X_explainer, _ = train_L2X(X_bg, y_bg, input_dim, d, X_bg) 
    ...
    ##----------------------------------------------------------------------------------------------------------   
        ...
        for num_samples in sample_sizes:
            ...
            if num_samples == int(mid_value):
                ...
                l_fNET_gsp_scores, _, _ = featureNet_gumbelsparsemax_model.predict(X_tensor_tbx)
                hsic_fNET_gsp_scores = l_fNET_gsp_scores.detach().cpu().numpy()
                ##---------------------
                ...
                l_fNET_gso_scores, _, _ = featureNet_gumbelsoftmax_model.predict(X_tensor_tbx)
                hsic_fNET_gso_scores = l_fNET_gso_scores.detach().cpu().numpy()
                ##------------------
                ...
                l_fNET_sp_scores, _, _ = featureNet_sparsemax_model.predict(X_tensor_tbx)
                hsic_fNET_sp_scores = l_fNET_sp_scores.detach().cpu().numpy()
                ##---------------------------
               
                L2X_explainer.eval()
                # X_test_tensor = torch.tensor(X_tbx, dtype=torch.float32)
                with torch.no_grad():
                         _, l_L2X_scores = L2X_explainer(X_tensor_tbx, training=False)

                L2X_scores= l_L2X_scores.cpu().numpy()
                ...
                gsp_fNET_removal_effect, gsp_fNET_removal_effect_normalized, gsp_fNET_y_gt = feature_removing_effect(hsic_fNET_gsp_shap_values, X_tbx, X_bg, exp_func, remove_feature)
                ...
                gso_fNET_removal_effect, gso_fNET_removal_effect_normalized, gso_fNET_y_gt = feature_removing_effect(hsic_fNET_gso_shap_values, X_tbx, X_bg, exp_func, remove_feature)
                ...
                sp_fNET_removal_effect, sp_fNET_removal_effect_normalized, sp_fNET_y_gt = feature_removing_effect(hsic_fNET_sp_shap_values, X_tbx, X_bg, exp_func, remove_feature)
                ...
                gsp_fNET_score_removal_effect, gsp_fNET_score_removal_effect_normalized, _ = feature_removing_effect(hsic_fNET_gsp_scores, X_tbx, X_bg, exp_func, remove_feature)
                ...
                gso_fNET_score_removal_effect, gso_fNET_score_removal_effect_normalized, _ = feature_removing_effect(hsic_fNET_gso_scores, X_tbx, X_bg, exp_func, remove_feature)
                ...
                sp_fNET_score_removal_effect, sp_fNET_score_removal_effect_normalized, _ = feature_removing_effect(hsic_fNET_sp_scores, X_tbx, X_bg, exp_func, remove_feature)
    ...
    ##---------------------------------------------------------------------------------------------------------
        ...
        method_names = [
            ...
            'HSICFeatureNet_GumbelSparsemax', 'HSICFeatureNet_GumbelSparsemax_scores',
            'Hsic_GumbelSoftmax', 'Hsic_GumbelSoftmax_scores',
            'HsicFeatureNet_GumbelSoftmax', 'HsicFeatureNet_GumbelSoftmax_scores',
            'Hsic_Sparsemax', 'Hsic_Sparsemax_scores',
            'HsicFeatureNet_Sparsemax', 'HsicFeatureNet_Sparsemax_scores',
        ...
        mean_results = [
            ...
            np.mean(gsp_fNET_removal_effect, axis=0),
            np.mean(gsp_fNET_score_removal_effect, axis=0),
            np.mean(gso_removal_effect, axis=0),
            np.mean(gso_score_removal_effect, axis=0),
            np.mean(gso_fNET_removal_effect, axis=0),
            np.mean(gso_fNET_score_removal_effect, axis=0),
            np.mean(sp_removal_effect, axis=0),
            np.mean(sp_score_removal_effect, axis=0),
            np.mean(sp_fNET_removal_effect, axis=0),
            np.mean(sp_fNET_score_removal_effect, axis=0),
        ...
        std_results = [
            ...
            np.std(gsp_fNET_removal_effect, axis=0),
            np.std(gsp_fNET_score_removal_effect, axis=0),
            np.std(gso_removal_effect, axis=0),
            np.std(gso_score_removal_effect, axis=0),
            np.std(gso_fNET_removal_effect, axis=0),
            np.std(gso_fNET_score_removal_effect, axis=0),
            np.std(sp_removal_effect, axis=0),
            np.std(sp_score_removal_effect, axis=0),
            np.std(sp_fNET_removal_effect, axis=0),
            np.std(sp_fNET_score_removal_effect, axis=0),
        ...
        mean_results_normalized = [
            ...
            np.mean(gsp_score_removal_effect_normalized2, axis=0),
             np.mean(gsp_fNET_removal_effect_normalized, axis=0),
            np.mean(gsp_fNET_score_removal_effect_normalized, axis=0),
            np.mean(gso_removal_effect_normalized, axis=0),
            np.mean(gso_score_removal_effect_normalized, axis=0),
            np.mean(gso_fNET_removal_effect_normalized, axis=0),
            np.mean(gso_fNET_score_removal_effect_normalized, axis=0),
            np.mean(sp_removal_effect_normalized, axis=0),
            np.mean(sp_score_removal_effect_normalized, axis=0),
            np.mean(sp_fNET_removal_effect_normalized, axis=0),
            np.mean(sp_fNET_score_removal_effect_normalized, axis=0),
        ...
        std_results_normalized = [
            ...
            np.std(gsp_fNET_removal_effect_normalized, axis=0),
            np.std(gsp_fNET_score_removal_effect_normalized, axis=0),
            np.std(gso_removal_effect_normalized, axis=0),
            np.std(gso_score_removal_effect_normalized, axis=0),
            np.std(gso_fNET_removal_effect_normalized, axis=0),
            np.std(gso_fNET_score_removal_effect_normalized, axis=0),
            np.std(sp_removal_effect_normalized, axis=0),
            np.std(sp_score_removal_effect_normalized, axis=0),
            np.std(sp_fNET_removal_effect_normalized, axis=0),
            np.std(sp_fNET_score_removal_effect_normalized, axis=0),
        ...
        methods_data = {
            ...
            'HSICFeatureNet_GumbelSparsemax': gsp_fNET_y_gt,
            'Hsic_GumbelSoftmax': gso_y_gt,
            'HsicFeatureNet_GumbelSoftmax': gso_fNET_y_gt,
            'Hsic_Sparsemax': sp_y_gt,
            'HsicFeatureNet_Sparsemax': sp_fNET_y_gt,
            'L2X': L2X_y_gt,
